            ...
            <div className="mt-6 flex flex-col gap-3 text-sm">
              {profile.contact.email && (
                <a
                  ...
                  className="flex items-center gap-2.5 text-black/60 dark:text-white/60 hover:text-black dark:hover:text-white transition-colors"
                >
              ...
              {profile.contact.linkedin && (
                ...
                >
                  ...
                  <span>{profile.contact.linkedin.replace("https://", "")}</span>
                </a>
              )}
              {profile.contact.blog && (
                ...
                >
                  ...
                  <span>{profile.contact.blog.replace("https://", "")}</span>
                </a>
              )}
            </div>
          </div>
