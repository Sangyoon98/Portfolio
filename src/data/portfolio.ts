...
export const projects: Project[] = [
  ...
  },
  {
    ...
    detailedDescription:
      "현대오토에버 모빌리티 SW스쿨 웹/앱 2기 프로그램의 일환으로 개발된 중고차 거래 플랫폼입니다. Google OAuth 로그인, 일반 거래 및 경매 거래, My Page, 위시리스트, 계약서 기능을 개발했습니다.",
    tech: [
      "iOS",
      "SwiftUI",
      "Alamofire",
  ...
  },
  {
    ...
    detailedDescription:
      "현대오토에버 모빌리티 SW스쿨 웹/앱 2기 프로그램의 일환으로 개발된 AI 기반 영화 리뷰 플랫폼입니다. 사용자 페이지 풀 구현 및 프론트엔드 개발 리딩, 로그인, 회원가입, 사용자 정보 조회 등 백엔드 기능 개발 지원을 담당했습니다.",
    tech: [
      "Java",
      "Spring Boot",
      "JPA",
  ...
  },
  {
    ...
    detailedDescription:
      "현대오토에버 모빌리티 SW스쿨 웹/앱 2기 활동의 일환으로 개발된 현대자동차 특화 차량 리뷰 플랫폼입니다. 차량 리뷰 목록 및 필터 Backend & Frontend 개발, 게시글 댓글 기능 Backend & Frontend 개발, QueryDSL을 사용하여 필터링 속도 개선을 담당했습니다.",
    tech: [
      "Java",
      "Spring Boot",
      "JPA",
  ...
  },
  {
    ...
    detailedDescription:
      "WebView Bridge를 사용하여 DICOM 웹 모바일 화면 연동 개발, SendBird SDK를 분석 및 커스텀하여 앱 내 채팅 기능 개발, Firebase Cloud Messaging을 사용하여 실시간 알림 기능 개발, 시큐어코딩을 적용하여 CycloneDX를 앱 내 적용을 담당했습니다.",
  ...
  },
  {
    ...
    detailedDescription:
      "이원화 앱으로 시설앱, 부모앱으로 나누어 개발, 급식 감수 신청 로직 구상 및 구현, Firebase Cloud Messaging을 사용하여 알림 기능 개발, REST API 인터페이스 설계서 구상 및 구현하여 다른 직군과 협업을 담당했습니다.",
  ...
  },
  {
    ...
    detailedDescription:
      "기존 앱을 리뉴얼하여 사용성 개선 및 재출시, 이원화 앱으로 시설앱, 부모앱으로 나누어 개발, Firebase Cloud Messaging을 사용하여 알림 기능 개발, REST API 인터페이스 설계서 구상 및 구현하여 다른 직군과 협업을 담당했습니다.",
    tech: ["Kotlin", "FCM", "Kakao Login API"],
    links: [
      {
  ...
  },
  {
    ...
    detailedDescription:
      "콩오더 사용자 앱, 콩오더 파트너스 앱(카페 사장용), 콩오더 파트너스 태블릿 앱으로 구성된 커피 픽업 전용 주문 플랫폼입니다. Toss Payments API 분석 및 설계, Google Login API와 Kakao Login API를 활용한 로그인 인증, Google Maps API를 활용한 지도 좌표 표시, Firebase Cloud Messaging을 활용한 워치 앱 연동 알림 기능, 태블릿 전용 레이아웃 기능 구성 및 개발을 담당했습니다.",
    tech: [
      "Kotlin",
      "Toss Payments API",
      "Google Login API",
